...
This is game that when you win you become a Hero.
...
git clone https://github.com/ngumamutundu/java_ipweek2.git
...
1. Clone the repository: `git clone https://github.com/ngumamutundu/java_ipweek2.git
